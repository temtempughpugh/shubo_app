    ...
    const daysSectionsHTML = pageDays.map(day => {
      ...
      if (works.preparations.length > 0) {
        ...
        works.preparations.forEach(shubo => {
          ...
          contentHTML += `<tr><td class="item-label">汲み水</td><td colspan="2">${waterAmount}L</td><td class="item-label">氷量</td><td colspan="2"></td></tr>`;
          contentHTML += `<tr><td class="item-label">準備水</td><td colspan="2"></td><td class="item-label">尺</td><td colspan="2"></td></tr>`;
        });
